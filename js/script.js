...
function loadFeaturedProducts() {
    ...
    // Shuffle all products and take first 8
    let featuredProducts = shuffleArray([...products]).slice(0, 8);
...
function loadCategoryProducts() {
    ...
    categoryProducts = shuffleArray(categoryProducts);
...
function setupProductGallery() {
    ...
    if (relatedContainer) {
        ...
        // SHUFFLE related products and take first 4
